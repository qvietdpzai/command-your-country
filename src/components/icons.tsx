...
export const Icon: React.FC<IconProps> = ({ name, ...props }) => {
    switch (name) {
        ...
        case 'conference': // Briefcase with people icon
            return (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
                    <path d="M8 8V6.5a2.5 2.5 0 0 1 5 0V8"/>
                    <path d="M12 12h.01"/>
                    <path d="M16 6.5a2.5 2.5 0 0 0-5 0V8"/>
                    <path d="M18 8h1a4 4 0 0 1 4 4v6a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-6a4 4 0 0 1 4-4h1"/>
                </svg>
            );
        case 'speaking': // Waveform icon
            return (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
                    <path d="M3 10v4"/>
                    <path d="M8 8v8"/>
        ...
        case 'microphone': // Microphone icon
            return (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
