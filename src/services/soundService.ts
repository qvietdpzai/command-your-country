...
const sounds: Record<SoundName, string> = {
    ...
    start_game: 'data:audio/wav;base64,UklGRkYAAABXQVZFZm10IBAAAAABAAIARKwAABCxAgAEABAAZGF0YVwAAACAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgIA==',
    ...
    stat_decrease: 'data:audio/wav;base64,UklGRiIAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAAABkYXRhHwAAAP38/f39/f7+/v7+/v7+/v7+/v7+/v7+/v4=',
    ...
    background_music: 'data:audio/mpeg;base64,'
};
