...
const sounds: Record<SoundName, string> = {
    ...
    start_game: 'data:audio/wav;base64,UklGRooAAABXQVZFZm10IBAAAAABAAIARKwAABCxAgAEABAAZGF0YQAAAAA=', // Corrected invalid base64 string
    send_command: 'data:audio/wav;base64,UklGRiIAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAAABkYXRhPAAAAP////8AAP////8AAP////8AAP////8AAP////8AAP////8AAP////8AAP////8AAP////8AAP////8AAP////8A==', // Corrected invalid base64 string (added padding)
    ...
    background_music: 'data:audio/mpeg;base64,'
};
